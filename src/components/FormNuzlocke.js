    ...
    return(
        <div>
            <form onSubmit={(e)=>{e.preventDefault();
                ...
                <fieldset>
                <select name="version" id="version" onSelect={(e)=>setGameVersionHolder(e.target.value)} onSelect={(e)=>setGameGenerationHolder(e.target.label)}>
                ...
                <select name="type" id="type" onSelect={(e)=>setTypeHolder(e.target.value)}>
                    ...
                    {gameGenerationholder!=="generation-i" ? <option value = "dark">Dark</option> : null}
                    {gameGenerationholder!=="generation-i" ? <option value = "steel">Steel</option> : null}
                    <option value = "bug">Bug</option>
                    <option value = "normal" >Normal</option>
                    <option value = "dragon">Dragon</option>
                    <option value = "ice">Ice</option>
                    {(gameGenerationholder==="generation-vi" || gameGenerationholder==="generation-vii") ? <option value = "fairy">Fairy</option> : null}
                </select>
